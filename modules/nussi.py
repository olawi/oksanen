...
nusphrases = [ r"%s, %s olis vailla!", 
               ...
               r"%s ja %s, kiimanne on kyltymättömyydessään kuin käytöstä poistettu vesivoimala.",
               ...
               r"your name is %s. You will be hässimiläted by %s.",
               r"%s ja %s, olette kuin kosteat kaniinit rakkautenne äärellä.",
